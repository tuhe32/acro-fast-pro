...
import type { TableColumnData, TableRowSelection as ITableRowSelection } from '@arco-design/web-vue/es/table/interface';
...
export interface TableRowSelection<T = any> extends ITableRowSelection {
   ...
   * @type FunctionT
   */
  onSelect?: (record: T, selected: boolean, selectedRows: Record<string, any>[], nativeEvent: Event) => any;
...
export interface BasicTableProps<T = any> {
   ...
   */
  expandIcon?: () => void | VNodeChild | JSX.Element;
   ...
   * @type Function | VNodeChild
   */
  footer?: () => void | VNodeChild | JSX.Element;
   ...
   * @type Function
   */
  customHeaderRow?: (column: TableColumnData, index: number) => Record<string, unknown>;
